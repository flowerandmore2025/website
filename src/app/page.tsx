                    ...
                    {[
                        {
                            ...
                            content: "ดอกไม้สด สวยสดชื่น ประทับใจมาก ขอแนะนำเลยค่ะ ใครที่กำลังมองหาร้านดอกไม้สดสำหรับโอกาสพิเศษ ไม่ผิดหวังแน่นอน!",
                        },
                        {
                            name: "อรัชพร",
                            role: "นักธุรกิจ",
                            content: "สั่งซื้อดอกไม้ประดิษฐ์จากร้านนี้เพื่อนำไปตกแต่งบ้านและเป็นของขวัญให้เพื่อน บอกเลยว่าทึ่งมาก! ดอกไม้ทำได้เหมือนจริงสุด ๆ ทั้งสี การไล่เฉด และรายละเอียดเล็ก ๆ อย่างกลีบดอกหรือเกสร เรียกว่าคนที่เห็นนึกว่าดอกไม้จริงเลยค่ะ วัสดุที่ใช้ก็ดูดี ทนทาน ไม่ก๊องแก๊งเหมือนที่เคยเจอจากร้านอื่น" +
