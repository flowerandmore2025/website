...
const vaseBouquet: Omit<Product, "category">[] = [
    {
        ...
        description:
            "การจัดดอกกุหลาบและดอกลิลลี่สดในแจกันคริสตัลอย่างสวยงาม เหมาะสำหรับโอกาสพิเศษ",
        inStock: true,
        isPopular: true,
    },
    {
        ...
        description:
            "ดอกทานตะวันและดอกเดซี่สีสดใสจัดในแจกันเซรามิกแบบรัสติก นำแสงแดดมาสู่ทุกห้อง",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกโปยอนีสีชมพูและกุหลาบขาวในแจกันสไตล์วินเทจ เหมาะสำหรับวันครบรอบ",
        inStock: true,
        isPopular: true,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกไม้ป่าแบบรัสติกในแจกันแบบเมสันจาร์ นำเสน่ห์ชนบทมาสู่บ้านของคุณ",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกทิวลิปสีขาวแบบมินิมอลในแจกันแก้วใส สะท้อนถึงความเรียบง่ายและความหรูหรา",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การผสมผสานดอกเกอร์เบอร่าเดซี่สีรุ้งอย่างสดใส จัดในแจกันเซรามิกสีเหลืองสดใส",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกแอนีโมนสีม่วงและขาวอย่างหรูหราในแจกันแก้วเมอร์คิวรี่ เพิ่มความหรูหรา",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกคาร์เนชั่นสีชมพูและดอกยิปซี่ในแจกันแก้วสีชมพูฟรอสต์ เหมาะสำหรับวันแม่",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดหน่อไม้ไผ่และกล้วยไม้ขาวในแจกันหินทรงสี่เหลี่ยม สร้างความสงบแบบเซน",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกลิลลี่สีส้มและดอกเบญจมาศสีเหลืองในแจกันทองแดง เฉลิมฉลองฤดูใบไม้ร่วง",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกคาล่าลิลลี่ขาวและยูคาลิปตัสในแจกันคริสตัลทรงสูง แสดงถึงความหรูหรา",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกลิซิแอนทัสสีม่วงและดอกรานังคูลัสสีชมพูในแจกันขวดนมวินเทจ น่ารักและหวาน",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกทิวลิปสีเหลืองและดอกไอริสสีฟ้าอย่างสดใสในแจกันเซรามิกวาดมือ",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกลาเวนเดอร์และโรสแมรี่หอมในกระถางเทอราคอตตา นำกลิ่นหอมของสวนโพรวองซ์",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกกุหลาบสีแดงเข้มและขนนกสีดำในแจกันสีดำด้าน เหมาะสำหรับสไตล์กอธิค",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกเครือพักตร์นกและขิงแดงในแจกันตกแต่งด้วยไม้ไผ่ นำความอบอุ่นแบบเมืองร้อน",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดดอกซากุระและดอกไฮยาซินธ์ขาวในแจกันเซรามิกสไตล์ญี่ปุ่น เฉลิมฉลองฤดูใบไม้ผลิ",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "ช่อดอกไม้สดสวยงามด้วยสีสันและพื้นผิวที่ผสมผสานกันอย่างลงตัว เหมาะสำหรับทุกโอกาส",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การผสมผสานดอกไม้ตามฤดูกาลที่สวยงามในสีสันสดใส จัดในแจกันเซรามิกตกแต่ง",
        inStock: true,
        isPopular: false,
    },
    {
    ...
    },
    {
        ...
        description:
            "การจัดดอกไม้ชั้นดีอย่างหรูหราในสีสันอันอุดมสมบูรณ์ นำเสนอในแจกันแก้วร่วมสมัย",
        inStock: true,
        isPopular: false,
    },
    {
        ...
        description:
            "การจัดแสดงดอกไม้แปลกตาและใบไม้อย่างมีศิลปะในแจกันดีไซน์เนอร์ สร้างความโดดเด่น",
        inStock: true,
        isPopular: false,
    },
    {
